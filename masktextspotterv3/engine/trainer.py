...
import torch
from masktextspotterv3.utils.comm import get_world_size, is_main_process
from masktextspotterv3.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("masktextspotterv3.trainer")
